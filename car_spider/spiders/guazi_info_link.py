...
class GuaziInfoLinkSpider(scrapy.Spider):
    ...
    def detail_parse(self, response):
        ...
        yield DetailItem(
            ...
            # /html/body/div[4]/div[5]/div[2]/table[1]/tbody/tr[2]/td[2]
            #  / html / body / div[4] / div[5] / div[2] / table[1] / tbody / tr[2] / td[2]
            ...
            struction= response.xpath('//div[@class="detailcontent clearfix js-detailcontent active"]/table[1]/tr[6]/td[2]/text()').getall()[0],
